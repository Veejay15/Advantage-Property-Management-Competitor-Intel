# Advantage Property Management Competitor Intelligence

A weekly competitor intelligence tool for Advantage Property Management (advantagepropertymgmt.com), built on Next.js + GitHub Actions + Claude API.

## What It Does

- Tracks competing property management company websites
...
GitHub Repo (this) ──► GitHub Actions (weekly cron, generates report)
       ...
       │
       └──► Vercel (auto-deploys, serves dashboard at advantage-intel.vercel.app)
```
